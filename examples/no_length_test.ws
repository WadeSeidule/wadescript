...
def test_lists() -> void {
    ...
    # Removed: print_str(f"Initial list length: {numbers.length}")
...
def main() -> int {
    print_str("Testing without .length...")
    print_str("")
