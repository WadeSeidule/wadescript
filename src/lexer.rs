...
mod tests {
    ...
    fn test_identifiers() {
        ...
        assert_eq!(tokens[3].token, Token::Identifier("y123".to_string()));
        assert_eq!(tokens[4].token, Token::Identifier("_private".to_string()));
    }
    ...
    fn test_keywords() {
        ...
        assert_eq!(tokens[4].token, Token::While);
    ...
    fn test_operators() {
        ...
        assert_eq!(tokens[5].token, Token::DoubleEqual);
    ...
    fn test_compound_operators() {
        ...
        assert_eq!(tokens[3].token, Token::SlashEqual);
        assert_eq!(tokens[4].token, Token::PlusPlus);
    ...
    fn test_delimiters() {
        ...
        assert_eq!(tokens[10].token, Token::Dot);
    }
    ...
    fn test_simple_expression() {
        ...
        assert_eq!(tokens[4].token, Token::IntLiteral(5));
    }
